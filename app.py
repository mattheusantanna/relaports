...
````md
# Sistema de Relatório de Peso de Caminhão

Sistema desenvolvido em Streamlit para preenchimento automático da planilha:

- Relatório de Peso de Caminhão
- Peso de Chegada
...
* Inclusão dinâmica de linhas
* Geração automática do Excel
* Mantém layout original da planilha
* Download imediato do relatório
